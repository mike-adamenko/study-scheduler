...
public class ClinicServiceTests {
    ...
    @Autowired
    protected PatientRepository owners;
    ...
    public void shouldFindOwnersByLastName() {
        Collection<Patient> patients = this.owners.findByLastName("Davis");
        assertThat(patients.size()).isEqualTo(2);

        patients = this.owners.findByLastName("Daviss");
        assertThat(patients.isEmpty()).isTrue();
    }

    @Test
    public void shouldFindSingleOwnerWithPet() {
        Patient patient = this.owners.findById(1);
    ...
    public void shouldInsertOwner() {
        Collection<Patient> patients = this.owners.findByLastName("Schultz");
        ...
        patients = this.owners.findByLastName("Schultz");
    ...
    public void shouldUpdateOwner() {
        ...
        patient = this.owners.findById(1);
    ...
    public void shouldInsertPetIntoDatabaseAndGenerateId() {
        Patient patient6 = this.owners.findById(6);
        ...
        this.pets.save(pet);
        this.owners.save(patient6);

        patient6 = this.owners.findById(6);
        assertThat(patient6.getPets().size()).isEqualTo(found + 1);
