...
//    public static class StudyControllerTests {
//
...
//            mockMvc.perform(get("/patients/*/pets/{petId}/visits/new", TEST_PET_ID))
...
//            mockMvc.perform(post("/patients/*/pets/{petId}/visits/new", TEST_PET_ID)
//                .param("name", "George")
